 ...
 */
public class Leaderboard3Fragment extends Fragment {
    ...
    private static final String getRankingsURL = "https://cs411fa18.web.illinois.edu/phpScripts/getRankingsAllTime.php";
    private static final String getRankingsByEmailURL = "https://cs411fa18.web.illinois.edu/phpScripts/getRankingByEmailAllTime.php";


    public Leaderboard3Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RootView = inflater.inflate(R.layout.fragment_leaderboard3, container, false);
